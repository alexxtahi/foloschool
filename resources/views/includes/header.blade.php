        ...
        <div class="col-lg-11 text-center text-lg-start mb-2 mb-lg-0">
            <div class="d-inline-flex align-items-center" style="height: 45px;">
                <small class="me-3 text-light">
                    ...
                    <a href="https://goo.gl/maps/3QXi1FhWwTuGbHFr7" target="_blank">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                <a href="{{ route('home') }}"
                    class="nav-item nav-link {{ $view_name == 'home' ? 'active' : '' }}">Accueil</a>
                <a href="{{ route('about') }}"
                    class="nav-item nav-link {{ $view_name == 'about' ? 'active' : '' }}">A propos</a>
                <a href="{{ route('avantages') }}"
                    class="nav-item nav-link {{ $view_name == 'avantages' ? 'active' : '' }}">Avantages</a>
                ...
                <a href="{{ route('contact') }}"
                    class="nav-item nav-link {{ $view_name == 'contact' ? 'active' : '' }}">Contact</a>
            </div>
